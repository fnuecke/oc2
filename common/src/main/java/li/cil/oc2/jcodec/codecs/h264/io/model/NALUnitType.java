...
public final class NALUnitType {
    ...
    private final static NALUnitType[] values;
    ...
    private NALUnitType(final int value, final String name, final String displayName) {
        this.value = value;
        this._name = name;
    ...
    public static NALUnitType fromValue(final int value) {
