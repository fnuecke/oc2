...
### Configuração
Configure os componentes de um computador através do seu ecrã de inventário. Para acessar este ecrã, abra o computador utilizando uma [wrench](../item/wrench.md) ou alterne para o ecrã de inventário através do botão de alternar à esquerda do ecrã de terminal.
