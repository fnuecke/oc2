...
## Iniciando
Para iniciar o seu computador acabado de construir, você vai precisar de lhe fornecer energia. Veja a barra de energia à esquerda do terminal ou do inventário. As suas dicas de ferramenta informa-no do nível de energia armazenada no seu computador atualmente, e a quantidade de energia requerida por tick para a contínua execução.
