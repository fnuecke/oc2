# Cartão de Interface de Redstone
...
A funcionalidade geral é idêntica à versão em bloco. A frente do [computador](../block/computer.md) representa a face primária como descrito na entrada [bloco de interface de redstone](../block/redstone_interface.md) do manual.
