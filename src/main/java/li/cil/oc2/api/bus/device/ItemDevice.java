 ...
 * created to copy data from and to the {@link net.minecraft.world.item.ItemStack} the device was
 * created for.
 * <p>
 * By default, no data is copied to and from the {@link net.minecraft.world.item.ItemStack}. Use
...
public interface ItemDevice extends Device {
    /**
     * Export data that should be copied to the {@link net.minecraft.world.item.ItemStack}
    ...
    /**
     * Import data that is present on the {@link net.minecraft.world.item.ItemStack} this
