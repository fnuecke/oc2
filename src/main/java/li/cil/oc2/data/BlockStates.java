...
//        final ModelFile baseModel = models().getExistingFile(new Identifier(API.MOD_ID, "block/cable_base"));
//        final ModelFile linkModel = models().getExistingFile(new Identifier(API.MOD_ID, "block/cable_link"));
//        final ModelFile plugModel = models().getExistingFile(new Identifier(API.MOD_ID, "block/cable_plug"));
//        final ModelFile straightModel = models().getExistingFile(new Identifier(API.MOD_ID, "block/cable_straight"));
//
